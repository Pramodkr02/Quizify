      ...
      <div className="max-w-md mx-auto bg-white rounded-lg shadow-lg p-8 text-center">
        {isRateLimitError ? (
          <>
            ...
            <h2 className="text-xl font-semibold text-gray-800 mb-2">Rate Limit Exceeded</h2>
            <p className="text-gray-600 mb-4">
              You've made too many requests to the quiz API. Please wait a moment before trying again.
            </p>
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-6">
              <p className="text-sm text-yellow-800">
                <strong>Tip:</strong> The quiz will automatically use sample questions if the API is unavailable.
              </p>
            </div>
          </>
        ) : isNetworkError ? (
          <>
            ...
            <h2 className="text-xl font-semibold text-gray-800 mb-2">Network Error</h2>
            <p className="text-gray-600 mb-4">
              Unable to connect to the quiz service. Please check your internet connection.
            </p>
          </>
        ) : (
          <>
        ...
        <div className="mt-6 text-xs text-gray-500">
          <p>If the problem persists, the quiz will automatically use sample questions.</p>
        </div>
      </div>
    </div>
  );
